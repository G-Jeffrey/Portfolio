    ...
    return (
        <Container>
            ...
            <DndList data={[{desc: "Baccalaureate in Computer Science 2 1/2 years, 120+ credits", url: './projects/icon/qc.png', name: 'Undergrad at Queens College' },
                            ...
                            {desc:'"CSSI is an online, four-week introduction to computer science (CS) for rising first year college students with a passion for technology."',link:'https://buildyourfuture.withgoogle.com/programs/computer-science-summer-institute',url:'./projects/icon/Google.png',name:'Google CSSI'},
