...
const useStyles = createStyles((theme) => (
  {
    ...
    backgroundImg: {
      ...
      backgroundImage: `url("./background/Title.svg")`,
  ...
  return (
    ...
    <Element name="background" key={'title'} >
      <div className={classes.wrapper}>
        ...
        <div className={classes.backgroundImg} style={{'zIndex':5}}>
                ...
                <Group noWrap>
                  ...
                  <div>
                    ...
                    <h1 className={classes.title}>
                      ...
                      <Typewriter onInit={async (typewriter) => { await typewriter.typeString('Jeffrey Guan').start()}}/>
                    </h1>
